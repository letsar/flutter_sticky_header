...
class TripleIndentedHeaderExample extends StatelessWidget {
  const TripleIndentedHeaderExample({
    Key? key,
  }) : super(key: key);
...
class _StickyHeaderListLevel2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverStickyHeader(
      header: Header(title: "Subheader $index"),
      slivers: [
...
class _StickyHeaderListLevel3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverStickyHeader(
      header: Header(title: "Subsubheader $index"),
      slivers: [
        SliverList(
